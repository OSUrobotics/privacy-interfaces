...
from geometry_msgs.msg import Pose, PoseArray, Point32, PolygonStamped, PoseWithCovarianceStamped
import random
import tf
...
class SimulatedRobot():
    def __init__(self):
        ...
        self.pub_amcl_pose = rospy.Publisher('/amcl_pose', PoseWithCovarianceStamped)
    ...
    def send(self):
        ...
        self.pub_amcl_pose.publish(self.amcl_pose)
    ...
    def update_amcl(self, dev, N):
        ...
        self.amcl_pose.header.frame_id = "/map"
        self.amcl_pose.header.stamp = rospy.Time.now()
        [self.amcl_pose.pose.pose.position.x,
         self.amcl_pose.pose.pose.position.y,
         self.amcl_pose.pose.pose.position.z] = [2.0, 3.0, 0.0]
        [self.amcl_pose.pose.pose.orientation.x,
         self.amcl_pose.pose.pose.orientation.y,
         self.amcl_pose.pose.pose.orientation.z,
         self.amcl_pose.pose.pose.orientation.w] = [0.0, 0.0, 0.0, 1.0]
        self.amcl_pose.pose.covariance[0]  = dev**2  # set variances = sdev^2
        self.amcl_pose.pose.covariance[7]  = dev**2
        self.amcl_pose.pose.covariance[35] = dev**2
